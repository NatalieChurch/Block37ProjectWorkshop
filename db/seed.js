...
const species = [
    ...
    {name: 'House Finch', population: 267000000, diet: 'herbivore', color: 'brown', group_name: 'Songbirds'},
    {name: 'Purple Finch', population: 6500000, diet: 'herbivore', color: 'reddish purple', group_name: 'Songbirds'},
    {name: 'American Goldfinch', population: 44000000, diet: 'herbivore', color: 'yellow, black', group_name: 'Songbirds'},
    {name: 'Common Sparrow', population: 740000000, diet: 'herbivore', color: 'brown, white, black', group_name: 'Songbirds'},
    {name: 'American Robin', population: 370000000, diet: 'herbivore', color: 'orange, grey, black', group_name: 'Songbirds'},
    {name: 'Black-Capped Chickadee', population: 41000000, diet: 'herbivore', color: 'white, grey, black', group_name: 'Songbirds'},
    {name: 'White-Breasted Nuthatch', population: 10000000, diet: 'herbivore', color: 'white, grey, black', group_name: 'Songbirds'},
    {name: 'Baltimore Oriole', population: 12000000, diet: 'herbivore', color: 'orange, black, white', group_name: 'Songbirds'},
    {name: 'Indigo Bunting', population: 78000000, diet: 'herbivore', color: 'indigo', group_name: 'Songbirds'},
    {name: 'Northern Cardinal', population: 130000000, diet: 'herbivore', color: 'red', group_name: 'Songbirds'},
    {name: 'Red-Winged Blackbird', population: 150000000, diet: 'herbivore', color: 'red, black', group_name: 'Songbirds'},
    {name: 'Rusty Blackbird', population: 6800000, diet: 'herbivore', color: 'brown, black', group_name: 'Songbirds'},
    {name: 'Laysan Honeycreeper', population: 0, diet: 'herbivore', color: 'unknown', group_name: 'Songbirds'},
    {name: 'Rose-Breasted Grosbeak', population: 4700000, diet: 'herbivore', color: 'red, black, white', group_name: 'Songbirds'},
    {name: 'Golden-Winged Grosbeak', population: 6500, diet: 'herbivore', color: 'yellow, brown, black', group_name: 'Songbirds'},
    {name: 'Barn Swallow', population: 190000000, diet: 'herbivore', color: 'brown, black, white, blue', group_name: 'Songbirds'},
    {name: 'Cave Swallow', population: 6800000, diet: 'herbivore', color: 'orange, black, brown', group_name: 'Songbirds'},
    {name: 'Tree Swallow', population: 20000000, diet: 'herbivore', color: 'blue, black, white', group_name: 'Songbirds'},
    {name: 'Hermit Thrush', population: 72000000, diet: 'herbivore', color: 'red, black', group_name: 'Songbirds'},
    {name: 'Pale Thrush', population: 10000, diet: 'herbivore', color: 'white, brown, grey', group_name: 'Songbirds'},
    {name: 'Gray Catbird', population: 29000000, diet: 'herbivore', color: 'grey', group_name: 'Songbirds'},
    ...
    {name: 'American White Pelican', population: 450000, diet: 'omnivore', color: 'white, grey', group_name: 'Waterfowl'},
    ...
    {name: 'Double-Crested Cormorant', population: 1000000, diet: 'omnivore', color: 'black', group_name: 'Waterfowl'},
    {name: 'Great Blue Heron', population: 700000, diet: 'omnivore', color: 'bluish grey, white, black', group_name: 'Waterfowl'},
    {name: 'Lesser Egret', population: 660000, diet: 'omnivore', color: 'white', group_name: 'Waterfowl'},
    ...
    {name: 'North Island Giant Moa', population: 0, diet: 'omnivore', color: 'unknown', group_name: 'Ratites'},
    {name: 'South Island Giant Moa', population: 0, diet: 'omnivore', color: 'unknown', group_name: 'Ratites'},
    {name: 'Upland Moa', population: 0, diet: 'omnivore', color: 'unknown', group_name: 'Ratites'},
    {name: 'Bush Moa', population: 0, diet: 'omnivore', color: 'unknown', group_name: 'Ratites'},
    {name: 'Broad-Billed Moa', population: 0, diet: 'omnivore', color: 'unknown', group_name: 'Ratites'},
    {name: 'Eastern Moa', population: 0, diet: 'omnivore', color: 'unknown', group_name: 'Ratites'},
    {name: 'Heavy-Footed Moa', population: 0, diet: 'omnivore', color: 'unknown', group_name: 'Ratites'},
    {name: 'Mantells Moa', population: 0, diet: 'omnivore', color: 'unknown', group_name: 'Ratites'},
    {name: 'Crested Moa', population: 0, diet: 'omnivore', color: 'unknown', group_name: 'Ratites'},
    {name: 'Giant Elephant Bird', population: 0, diet: 'omnivore', color: 'unknown', group_name: 'Ratites'},  
    {name: 'Hildebrandts Elephant Bird', population: 0, diet: 'omnivore', color: 'unknown', group_name: 'Ratites'},  
    {name: 'Lesser Elephant Bird', population: 0, diet: 'omnivore', color: 'unknown', group_name: 'Ratites'},  
]
